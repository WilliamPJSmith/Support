...
def setup(sim):
	...
	sim.addCell(cellType=0, len=lengthC, rad=radiusC, pos=(+init_sep/2.0,radiusC,0), dir=(1,0,0))
	sim.addCell(cellType=1, len=lengthC, rad=radiusC, pos=(-init_sep/2.0,radiusC,0), dir=(1,0,0))
