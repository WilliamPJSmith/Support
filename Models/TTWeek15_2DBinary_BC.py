...
def init(cell):
	if cell.cellType==0:
		cell.targetVol = targetVolb + random.uniform(0.0,0.09*targetVolb)
		cell.growthRate = 1
...
def divide(parent, d1, d2):
    ...
    if parent.cellType==0:
		d1.targetVol = targetVolb + random.uniform(0.0,0.09*targetVolb)
		d2.targetVol = targetVolb + random.uniform(0.0,0.09*targetVolb)
